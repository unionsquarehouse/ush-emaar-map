...
export default function EducationMarker({ location }) {
  return (
    <div className="text-black">
      <div className="flex flex-col items-center">
        <div className="relative group">
          ...
          <div
            className="size-8 text-[#036672] hover:text-[#036672] transition-colors duration-300 cursor-pointer"
          ...
          {/* <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="size-6 text-blue-400 hover:text-blue-600 transition-colors duration-300 cursor-pointer"
          >
